      ...
      <div className="w-full max-w-md space-y-6 animate-in fade-in duration-500">
        ...
        <div className="flex flex-col items-center space-y-3">
          ...
          <div className="text-center">
            <h1 className="text-2xl font-bold tracking-tight">Seja Sócio Torcedor</h1>
            <p className="text-sm text-primary font-semibold">Cruzeiro Esporte Clube</p>
          </div>
          <p className="text-sm text-muted-foreground">Junte-se à maior torcida de Minas</p>
        </div>
        ...
        <Card className="border-0 backdrop-blur-sm bg-card/80">
          <CardHeader className="space-y-1 pb-4">
            ...
            <CardDescription>Preencha seus dados para se tornar sócio</CardDescription>
          </CardHeader>
          <CardContent>
